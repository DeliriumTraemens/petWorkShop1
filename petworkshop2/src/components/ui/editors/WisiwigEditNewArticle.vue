<template>
    ...
    <div class="edwrap">
        ...
        <div class="button-wrap">
            ...
            <span>
                <v-btn small @click="undo" color="brown">
        ...
        <div
                ...
                class="wysiwyg-output outline-none border-3 p-6 rounded-lg border-gray-300 focus:border-green-300 overflow-y-auto"
                id="wised1"
        >
